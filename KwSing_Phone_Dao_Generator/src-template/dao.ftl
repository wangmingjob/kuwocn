...
import com.fightingtime.commons.dao.AbstractDao;
import com.fightingtime.commons.dao.Property;
<#if entity.toOneRelations?has_content>
import com.fightingtime.commons.dao.internal.SqlUtils;
</#if>
import com.fightingtime.commons.dao.internal.DaoConfig;
<#if entity.incomingToManyRelations?has_content>
import com.fightingtime.commons.dao.query.Query;
import com.fightingtime.commons.dao.query.QueryBuilder;
</#if>
