 ...
 */
public class SysVideoView extends SurfaceView implements MediaPlayerControl {
	private Uri mUri;
	...
	public SysVideoView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public SysVideoView(Context context, AttributeSet attrs, int defStyle) {
