...
public class AsyncHttpClient {
   ...
   /**
    ...
    public void get(Context context, String url, RequestParams params, AsyncHttpResponseHandler responseHandler) {
    	get(context, url, params, "UTF-8", responseHandler);
    }
    
    public void get(Context context, String url, RequestParams params, String encoding, AsyncHttpResponseHandler responseHandler) {
        sendRequest(httpClient, httpContext, new HttpGet(getUrlWithQueryString(url, params, encoding)), null, responseHandler, context);
    }
    ...
    public void get(Context context, String url, Header[] headers, RequestParams params, AsyncHttpResponseHandler responseHandler) {
    	get(context, url, headers, params, "UTF-8", responseHandler);
    }
    
    public void get(Context context, String url, Header[] headers, RequestParams params, String encoding, AsyncHttpResponseHandler responseHandler) {
    ...
    protected void sendRequest(DefaultHttpClient client, HttpContext httpContext, HttpUriRequest uriRequest, String contentType, AsyncHttpResponseHandler responseHandler, Context context) {
        ...
        KuwoLog.d("AsyncHttpClient", "sendRequest: " + uriRequest.getURI().toString());
    }

    public static String getUrlWithQueryString(String url, RequestParams params) {
    	return getUrlWithQueryString(url, params, "UTF-8");
    }
    
    public static String getUrlWithQueryString(String url, RequestParams params, String encoding) {
        if(params != null) {
