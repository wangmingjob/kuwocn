 ...
 *
 */
public class MtvCategoryAdapter extends BaseAdapter {
	...
	public MtvCategoryAdapter(Activity activity, List<ImageObject> imageObjectList, AnimateFirstDisplayListener animateFirstDisplayListener) {
		mActivity = activity;
